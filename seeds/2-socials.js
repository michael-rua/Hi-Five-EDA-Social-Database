exports.seed = (knex) => {
  return knex('socials').insert([
    { id: 1, facebook: 'Michael Rua', instagram: 'michaelrua', linkedIn: 'michaelrua', ps4_user: 'Aviator11', steam_user: 'Decoy.Bob', xbox_user: 'Not a chance!', github: 'michael-rua', twitter: '@michaeljrua', user_id: 1 },
    ...
    { id: 4, facebook: 'Benpai Mitchell', instagram: 'bathbuckies', linkedin: 'none', ps4_user: 'none', steam_user: 'batista', xbox_user: 'Mister Man Sir7', github: 'benmitchell11', twitter: 'lilgumboot', user_id: 4 }
