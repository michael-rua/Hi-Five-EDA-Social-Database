exports.seed = (knex) => {
  return knex('socials').insert([
    { id: 1, facebook: 'Michael Rua', instagram: 'michaelrua', linkedIn: 'michaelrua', ps4_user: 'Aviator11', steam_user: 'Decoy.Bob', xbox_user: 'xboc', github: 'michael-rua', twitter: '@michaeljrua', user_id: 1 },
